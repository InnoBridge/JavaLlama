 ...
 * {@link LlamaModel#generate(InferenceParameters)}
 * and
...
public final class InferenceParameters extends JsonParameters {
  ...
  /**
   * Set the last n tokens to consider for penalties (default: 64, 0 = disabled,
   * -1 = ctx_size)
   */
  ...
  /**
   * Set the penalty of repeated sequences of tokens (default: 1.0, 1.0 =
   * disabled)
   */
   ...
   * only the latter will be penalized if
   * repeated. See <a href="https://github.com/ggerganov/llama.cpp/pull/3727">pull
   * request 3727</a> for more details.
   */
   ...
   * E.g. if original prompt is "Alice: Hello!" and penaltyPrompt corresponds to
   * the token ids of "Hello!", only the
   * latter will be penalized if repeated.
   * See <a href="https://github.com/ggerganov/llama.cpp/pull/3727">pull request
   * 3727</a> for more details.
   */
  ...
  /**
   * Set whether to ignore end of stream token and continue generating (implies
   * --logit-bias 2-inf)
   */
   ...
   * E.g., <code>Map.of(15043, 1f)</code>
   * to increase the likelihood of token ' Hello', or a negative value to decrease
   * it.
  ...
  /**
   * Set tokens to disable, this corresponds to {@link #setTokenIdBias(Map)} with
   * a value of
  ...
  /**
   * Modify the likelihood of tokens appearing in the completion by their id.
   * E.g., <code>Map.of(" Hello", 1f)</code>
   * to increase the likelihood of token id 15043, or a negative value to decrease
   * it.
   * Note, this method overrides any previous calls to
   * <ul>
   * <li>{@link #setTokenIdBias(Map)}</li>
  ...
  /**
   * Set tokens to disable, this corresponds to {@link #setTokenBias(Map)} with a
   * value of
   * {@link Float#NEGATIVE_INFINITY}.
   * Note, this method overrides any previous calls to
   * <ul>
